...
if (num == 0) {
  ...
  // Si el residuo de la división por 2 es 0, entonces es par, sino impar
  console.log(num % 2 == 0 ? "El número es par" : "El número es impar");


  
  // OTRA FORMA: Si no es 0, verificamos si es par o impar
  if (num % 2 == 0) {
